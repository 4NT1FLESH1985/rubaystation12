...
/obj/machinery/space_heater/interact(mob/user)
	if(panel_open)
		...
		dat += "Power cell: "
		if(cell)
			dat += "<meta charset='utf-8'><A href='byond://?src=\ref[src];op=cellremove'>Installed</A><BR>"
		else
			dat += "<meta charset='utf-8'><A href='byond://?src=\ref[src];op=cellinstall'>Removed</A><BR>"

		dat += "Power Level: [cell ? round(cell.percent(),1) : 0]%<BR><BR>"

		dat += "Set Temperature: "

		dat += "<meta charset='utf-8'><A href='?src=\ref[src];op=temp;val=-5'>-</A>"

		dat += " [set_temperature]K ([set_temperature-T0C]&deg;C)"
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];op=temp;val=5'>+</A><BR>"
