...
/obj/machinery/computer/message_monitor/interact(var/mob/living/user)
	...
	dat += "<meta charset='utf-8'><center><h2>Message Monitor Console</h2></center><hr>"
	dat += "<meta charset='utf-8'><center><h4><font color='blue'[message]</h5></center>"

	if(auth)
		dat += "<meta charset='utf-8'><h4><dd><A href='?src=\ref[src];auth=1'>&#09;<font color='green'>\[Authenticated\]</font></a>&#09;/"
		...
		dat += "<meta charset='utf-8'><h4><dd><A href='?src=\ref[src];auth=1'>&#09;<font color='red'>\[Unauthenticated\]</font></a>&#09;/"
	...
	switch(screen)
		...
		if(0)
			//&#09; = TAB
			var/i = 0
			dat += "<meta charset='utf-8'><dd><A href='?src=\ref[src];find=1'>&#09;[++i]. Link To A Server</a></dd>"
			if(auth)
				if(!linkedServer || (linkedServer.stat & (NOPOWER|BROKEN)))
					dat += "<meta charset='utf-8'><dd><A>&#09;ERROR: Server not found!</A><br></dd>"
				else
					dat += "<meta charset='utf-8'><dd><A href='?src=\ref[src];viewr=1'>&#09;[++i]. View Request Console Logs </a></br></dd>"
					dat += "<meta charset='utf-8'><dd><A href='?src=\ref[src];clearr=1'>&#09;[++i]. Clear Request Console Logs</a><br></dd>"
					dat += "<meta charset='utf-8'><dd><A href='?src=\ref[src];pass=1'>&#09;[++i]. Set Custom Key</a><br></dd>"
			else
				dat += "<meta charset='utf-8'><br><hr><dd><span class='notice'>Please authenticate with the server in order to show additional options.</span>"
			if((istype(user, /mob/living/silicon/ai) || istype(user, /mob/living/silicon/robot)) && (user.mind.special_role && user.mind.original == user))
				...
				dat += "<meta charset='utf-8'><dd><A href='?src=\ref[src];hack=1'><i><font color='Red'>*&@#. Bruteforce Key</font></i></font></a></dd>"
		...
		if(4)
			...
			*/
			dat += "<meta charset='utf-8'><center><A href='?src=\ref[src];back=1'>Back</a> - <A href='?src=\ref[src];refresh=1'>Refresh</center><hr>"
