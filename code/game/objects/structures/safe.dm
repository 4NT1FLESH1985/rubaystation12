...
/obj/structure/safe/attack_hand(mob/user as mob)
	...
	var/dat = "<center>"
	dat += "<meta charset='utf-8'><a href='?src=\ref[src];open=1'>[open ? "Close" : "Open"] [src]</a> | <a href='?src=\ref[src];decrement=1'>-</a> [dial * 5] <a href='?src=\ref[src];increment=1'>+</a>"
	if(open)
		dat += "<meta charset='utf-8'><table>"
		for(var/i = contents.len, i>=1, i--)
			var/obj/item/P = contents[i]
			dat += "<meta charset='utf-8'><tr><td><a href='?src=\ref[src];retrieve=\ref[P]'>[P.name]</a></td></tr>"
