...
/obj/item/device/assembly/prox_sensor/interact(mob/user as mob)//TODO: Change this to the wires thingy
	...
	dat += "<meta charset='utf-8'><BR><A href='?src=\ref[src];scanning=1'>[scanning?"Armed":"Unarmed"]</A> (Movement sensor active when armed!)"
	dat += "<meta charset='utf-8'><BR><BR><A href='?src=\ref[src];refresh=1'>Refresh</A>"
	dat += "<meta charset='utf-8'><BR><BR><A href='?src=\ref[src];close=1'>Close</A>"
