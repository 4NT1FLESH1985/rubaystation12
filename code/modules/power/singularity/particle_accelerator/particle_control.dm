...
/obj/machinery/particle_accelerator/control_box/interact(mob/user)
	...
	dat += "<meta charset='utf-8'><A href='?src=\ref[src];close=1'>Close</A><BR><BR>"
	dat += "Status:<BR>"
	if(!assembled)
		dat += "Unable to detect all parts!<BR>"
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];scan=1'>Run Scan</A><BR><BR>"
	else
		...
		if(active)
			...
			dat += "Off <BR>"
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];togglep=1'>Toggle Power</A><BR><BR>"
		dat += "Particle Strength: [src.strength] "
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];strengthdown=1'>--</A>|<A href='?src=\ref[src];strengthup=1'>++</A><BR><BR>"
