...
/datum/category_item/player_setup_item/physical/flavor/content(var/mob/user)
	. += "<meta charset='utf-8'><b>Flavor:</b><br>"
	. += "<meta charset='utf-8'><a href='?src=\ref[src];flavor_text=open'>Set Flavor Text</a><br/>"
	. += "<meta charset='utf-8'><a href='?src=\ref[src];flavour_text_robot=open'>Set Robot Flavor Text</a><br/>"
