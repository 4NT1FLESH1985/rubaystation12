...
/datum/category_item/player_setup_item/player_global/ui/content(var/mob/user)
	. += "<meta charset='utf-8'><b>UI Settings</b><br>"
	. += "<meta charset='utf-8'><b>UI Style:</b> <a href='?src=\ref[src];select_style=1'><b>[pref.UI_style]</b></a><br>"
	. += "<meta charset='utf-8'><b>Custom UI</b> (recommended for White UI):<br>"
	...
	if(can_select_ooc_color(user))
		. += "<meta charset='utf-8'><b>OOC Color:</b> "
		if(pref.ooccolor == initial(pref.ooccolor))
			. += "<meta charset='utf-8'><a href='?src=\ref[src];select_ooc_color=1'><b>Using Default</b></a><br>"
		else
			. += "<meta charset='utf-8'><a href='?src=\ref[src];select_ooc_color=1'><b>[pref.ooccolor]</b></a> <table style='display:inline;' bgcolor='[pref.ooccolor]'><tr><td>__</td></tr></table> <a href='?src=\ref[src];reset=ooc'>reset</a><br>"
	. += "<meta charset='utf-8'><b>Client FPS:</b> <a href='?src=\ref[src];select_fps=1'><b>[pref.clientfps]</b></a><br>"
