...
/obj/item/folder/attack_self(mob/user as mob)
	...
	for(var/obj/item/paper_bundle/Pb in src)
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];remove=\ref[Pb]'>Remove</A> <A href='?src=\ref[src];rename=\ref[Pb]'>Rename</A> - <A href='?src=\ref[src];browse=\ref[Pb]'>[Pb.name]</A><BR>"
