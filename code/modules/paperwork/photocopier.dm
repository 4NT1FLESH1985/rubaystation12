...
/obj/machinery/photocopier/interact(mob/user)
	...
	if(copyitem)
		...
		if(toner)
			dat += "<meta charset='utf-8'><a href='byond://?src=\ref[src];copy=1'>Copy</a><BR>"
			dat += "Printing: [copies] copies."
			dat += "<meta charset='utf-8'><a href='byond://?src=\ref[src];min=1'>-</a> "
			dat += "<meta charset='utf-8'><a href='byond://?src=\ref[src];add=1'>+</a><BR><BR>"
	else if(toner)
		dat += "Please insert something to copy.<BR><BR>"
	if(istype(user,/mob/living/silicon))
		dat += "<meta charset='utf-8'><a href='byond://?src=\ref[src];aipic=1'>Print photo from database</a><BR><BR>"
