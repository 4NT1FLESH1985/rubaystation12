...
/obj/item/material/clipboard/attack_self(mob/user as mob)
	...
	if(haspen)
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];pen=1'>Remove Pen</A><BR><HR>"
	else
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];addpen=1'>Add Pen</A><BR><HR>"
	...
	if(toppaper)
		...
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];write=\ref[P]'>Write</A> <A href='?src=\ref[src];remove=\ref[P]'>Remove</A> <A href='?src=\ref[src];rename=\ref[P]'>Rename</A> - <A href='?src=\ref[src];read=\ref[P]'>[P.name]</A><BR><HR>"

	for(var/obj/item/paper/P in src)
		if(P==toppaper)
			continue
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];remove=\ref[P]'>Remove</A> <A href='?src=\ref[src];rename=\ref[P]'>Rename</A> - <A href='?src=\ref[src];read=\ref[P]'>[P.name]</A><BR>"
	for(var/obj/item/photo/Ph in src)
		dat += "<meta charset='utf-8'><A href='?src=\ref[src];remove=\ref[Ph]'>Remove</A> <A href='?src=\ref[src];rename=\ref[Ph]'>Rename</A> - <A href='?src=\ref[src];look=\ref[Ph]'>[Ph.name]</A><BR>"
