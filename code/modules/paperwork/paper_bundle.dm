...
/obj/item/paper_bundle/proc/show_content(mob/user as mob)
	...
	if(istype(pages[page], /obj/item/paper))
		...
		dat += "<meta charset='utf-8'><html><meta charset='utf-8'><head><title>[P.name]</title></head><body style='overflow:hidden'>"
		dat += "<meta charset='utf-8'><div> <img src='tmp_photo.png' width = '180'[P.scribble ? "<div> Written on the back:<br><i>[P.scribble]</i>" : null ]</body></html>"
