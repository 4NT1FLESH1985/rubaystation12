...
/mob/living/simple_animal/crow/show_inv(var/mob/user)
	...
	var/list/dat = list()
	if(access_card)
		dat += "<meta charset='utf-8'><b>ID:</b> [access_card] (<a href='?src=\ref[src];remove_inv=access cuff'>Remove</a>)"
	else
		dat += "<meta charset='utf-8'><b>ID:</b> <a href='?src=\ref[src];add_inv=access cuff'>Nothing</a>"
	if(messenger_bag)
		dat += "<meta charset='utf-8'><b>Back:</b> [messenger_bag] (<a href='?src=\ref[src];remove_inv=back'>Remove</a>)"
	else
		dat += "<meta charset='utf-8'><b>Back:</b> <a href='?src=\ref[src];add_inv=back'>Nothing</a>"
