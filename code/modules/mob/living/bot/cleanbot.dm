...
/mob/living/bot/cleanbot/GetInteractTitle()
	...
	. += "<meta charset='utf-8'><b>Automatic Cleaner v1.0</b>"

/mob/living/bot/cleanbot/GetInteractPanel()
	. = "Cleans blood: <a href='?src=\ref[src];command=blood'>[blood ? "Yes" : "No"]</a>"
	. += "<meta charset='utf-8'><br>Patrol station: <a href='?src=\ref[src];command=patrol'>[will_patrol ? "Yes" : "No"]</a>"
...
/mob/living/bot/cleanbot/GetInteractMaintenance()
	...
	. += "<meta charset='utf-8'><br>Weird button pressed: <a href='?src=\ref[src];command=oddbutton'>[oddbutton ? "Yes" : "No"]</a>"
