...
/obj/item/device/bot_controller/interact(var/mob/user)
	...
	dat += "<meta charset='utf-8'><a href='byond://?src=\ref[src];look=[is_looking];'>[is_looking ? "Stop" : "Start"] Looking</a><br>"
	dat += "<meta charset='utf-8'><a href='byond://?src=\ref[src];drop=1;'>Drop Item</a><br></center>"
