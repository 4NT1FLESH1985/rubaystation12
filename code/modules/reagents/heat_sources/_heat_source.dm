...
/obj/machinery/reagent_temperature/interact(var/mob/user)
	...
	dat += "<meta charset='utf-8'><tr><td>Target temperature:</td><td>"

	if(target_temperature > min_temperature)
		dat += "<meta charset='utf-8'><a href='?src=\ref[src];adjust_temperature=-[heating_power]'>-</a> "
	...
	dat += "<meta charset='utf-8'><tr><td>Current temperature:</td><td>[Floor(temperature - T0C)]C</td></tr>"

	dat += "<meta charset='utf-8'><tr><td>Loaded container:</td>"
	dat += "<meta charset='utf-8'><td>[container ? "[container.name] ([Floor(container.temperature - T0C)]C) <a href='?src=\ref[src];remove_container=1'>Remove</a>" : "None."]</td></tr>"

	dat += "<meta charset='utf-8'><tr><td>Switched:</td><td><a href='?src=\ref[src];toggle_power=1'>[use_power == POWER_USE_ACTIVE ? "On" : "Off"]</a></td></tr>"
	dat += "<meta charset='utf-8'></table>"
