...
/obj/item/device/eftpos/attack_self(mob/user as mob)
	if(get_dist(src,user) <= 1)
		...
		dat += "<meta charset='utf-8'><i>This terminal is</i> [machine_id]. <i>Report this code when contacting IT Support</i><br>"
		if(transaction_locked)
			dat += "<meta charset='utf-8'><a href='?src=\ref[src];choice=toggle_lock'>Back[transaction_paid ? "" : " (authentication required)"]</a><br><br>"
			...
			if(transaction_paid)
				dat += "<meta charset='utf-8'><i>This transaction has been processed successfully.</i><hr>"
			else
				dat += "<meta charset='utf-8'><i>Swipe your card below the line to finish this transaction.</i><hr>"
				dat += "<meta charset='utf-8'><a href='?src=\ref[src];choice=scan_card'>\[------\]</a>"
		else
			dat += "<meta charset='utf-8'><a href='?src=\ref[src];choice=toggle_lock'>Lock in new transaction</a><br><br>"

			dat += "<meta charset='utf-8'><a href='?src=\ref[src];choice=trans_purpose'>Transaction purpose: [transaction_purpose]</a><br>"
			...
			dat += "<meta charset='utf-8'><a href='?src=\ref[src];choice=change_code'>Change access code</a><br>"
			dat += "<meta charset='utf-8'><a href='?src=\ref[src];choice=change_id'>Change EFTPOS ID</a><br>"
