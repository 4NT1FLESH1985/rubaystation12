...
/datum/extension/interactive/multitool/circuitboards/shuttle_console/get_interact_window(var/obj/item/device/multitool/M, var/mob/user)
	...
	var/dat = list()
	dat += "<meta charset='utf-8'><b>Current Selected Shuttle:</b>  [board.shuttle_tag || "NONE"]<br>"
	dat += "<meta charset='utf-8'><a href='?src=\ref[src];sync=1'>Synchronize to current shuttle.</a>"
	return JOINTEXT(dat)
